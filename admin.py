...
class Roundadmin(admin.ModelAdmin):
	...
	('General Information', {'fields': [
	 ('pf_number', "round_number", "room"), ("reporter_team", "opponent_team")]}),
	(None, {'fields': [("reporter"), ('opponent'), 'problem_presented']})
	]
	...
	class Media:
		js = ('js/jquery.js','admin/js/participant_fill.js',)
...
class ParticipantAdmin(ImportExportModelAdmin): #(admin.ModelAdmin):
	...
	def get_queryset(self,request):
		...
		if request.user.is_superuser:
			return qs
		return qs.filter(team = u.Team_FPT2019)

class JuryAdmin(ImportExportModelAdmin): #(admin.ModelAdmin):

	list_display = ('surname','name','team','affiliation','pf1','pf2','pf3','pf4','remark',)
	list_filter = ('team','pf1','pf2','pf3','pf4')
